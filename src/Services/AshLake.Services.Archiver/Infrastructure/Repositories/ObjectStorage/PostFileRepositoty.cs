...
public class PostFileRepositoty : IPostFileRepositoty
{
    private readonly MinioClient _minioClient;
    private const string Bucket = "post-file";

    public PostFileRepositoty(IOptions<PostFileStorageSetting> setting)
    {
